...
$result = [];
$sql = "SELECT * FROM Livro l inner join Favoritos f on l.bookId = f.FK_bookId and f.FK_userId = ?
order by l.titulo";
...
if ($result->num_rows > 0) {
  ...
  ?>
      ...
      <div class="pai_do_quadrado">
            ...
            <button class="acao" onclick="toggleLivro(<?php echo $row['bookId']; ?>, this);"><?php if ($row['FK_bookId'] != null) { echo 'Remover'; } ?></button>
        </div>
  ...
  echo "<div id='div-single-center'> Faça seu login para acessar seus livros</div>";;
}
?>
